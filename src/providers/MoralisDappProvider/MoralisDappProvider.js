...
function MoralisDappProvider({ children }) {
  ...
  const [contractAddress, setContractAddress] = useState("0x7Eea8EB4c4F0A34d0e72c935763C6dEA62C93316");
  const [selectedCategory, setSelectedCategory] = useState({"categoryId":"0x91","category":"default"});

  // const [rDBIDsFromOwner, setrDBIDsFromOwner] = useState(["test"]);
  // const [RDBImageLinks, setRDBImageLinks] = useState(["test"]);
  // const [RDBNames, setRDBNames] = useState(["test"]);
  // const [RDBSymbols, setRDBSymbols] = useState(["test"]);
  // const [RDBMetadata, setRDBMetadata] = useState([]);
  ...
  useEffect(() => {
    ...
    //             arrayRDBIDsFromOwner.push(value.result[i].token_id);
